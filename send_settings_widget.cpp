#include "send_settings_widget.h"
#include "ui_send_settings_widget.h"

#include <QPainter>

SendSettingsWidget::SendSettingsWidget(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::SendSettingsWidget)
{
    ui->setupUi(this);
}

SendSettingsWidget::~SendSettingsWidget()
{
    delete ui;
}
