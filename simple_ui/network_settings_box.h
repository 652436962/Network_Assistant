...
public:
    ...
    void setupUi(QWidget *NetworkSettingsWidget)
    {
        ...
        pushButton_Other = new QPushButton(NetworkSettingsWidget);
        ...
        spinBox = new QSpinBox(NetworkSettingsWidget);
    ...
    void retranslateUi(QWidget *NetworkSettingsWidget)
    {
        ...
        pushButton_Other->setText(QCoreApplication::translate("NetworkSettingsWidget", "\345\205\266\345\256\203", nullptr));
